...
#ifdef DEBUG
    #define TRACE_LEVEL_CUSTOM     TRACE_LEVEL_INFO
#else
    #define TRACE_LEVEL_CUSTOM     TRACE_LEVEL_ERROR
#endif

#define PPP_SUPPORT             ENABLED
#define PPP_TRACE_LEVEL         TRACE_LEVEL_CUSTOM//4
...
// TRACE_LEVEL_INFO     4
// TRACE_LEVEL_DEBUG    5
#define MEM_TRACE_LEVEL          TRACE_LEVEL_CUSTOM//4
#define NIC_TRACE_LEVEL          TRACE_LEVEL_CUSTOM//4
...
#define SLAAC_TRACE_LEVEL        TRACE_LEVEL_CUSTOM//4
#define DHCP_TRACE_LEVEL         TRACE_LEVEL_CUSTOM//4
#define DHCPV6_TRACE_LEVEL       TRACE_LEVEL_CUSTOM//4
#define DNS_TRACE_LEVEL          TRACE_LEVEL_CUSTOM//4
#define MDNS_TRACE_LEVEL         TRACE_LEVEL_CUSTOM//4
#define NBNS_TRACE_LEVEL         2
#define LLMNR_TRACE_LEVEL        TRACE_LEVEL_CUSTOM//4
#define FTP_TRACE_LEVEL          TRACE_LEVEL_CUSTOM//4
#define HTTP_TRACE_LEVEL         TRACE_LEVEL_CUSTOM//4
#define SMTP_TRACE_LEVEL         TRACE_LEVEL_CUSTOM//4
#define SNTP_TRACE_LEVEL         TRACE_LEVEL_CUSTOM//4
#define STD_SERVICES_TRACE_LEVEL TRACE_LEVEL_CUSTOM//4
