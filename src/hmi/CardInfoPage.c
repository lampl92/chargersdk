...
static void Data_Flush(WM_MESSAGE *pMsg)
{
    ...
    uxBitRFID = xEventGroupWaitBits(pRFIDDev->xHandleEventGroupRFID, defEventBitBadIDReqDisp, pdTRUE, pdTRUE, 0);
...
static void _cbDialog(WM_MESSAGE * pMsg) {
    ...
    case WM_INIT_DIALOG:
      ...
      //
        ...
        Text_Show(WM_GetDialogItem(pMsg->hWin, ID_TEXT_2), &SIF24_Font, FONT_COLOR, pRFIDDev->order.strCardID);//卡号
