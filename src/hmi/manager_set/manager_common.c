...
#define ID_WINDOW_1 (GUI_ID_USER + 0x05)
...
WM_HWIN CreateManagerCommon(void)
{
    ...
    _hWinManagerQuit = GUI_CreateDialogBox(_aDialogCreate1, GUI_COUNTOF(_aDialogCreate1), _cbDialog1, _hWinManagerCommon, 0, 0);
