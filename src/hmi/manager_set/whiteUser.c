...
#define ID_BUTTON_3  (GUI_ID_USER + 0x05)//删除
...
static const GUI_WIDGET_CREATE_INFO _aDialogCreate[] =
{
    ...
    { BUTTON_CreateIndirect, "add", ID_BUTTON_0, 175, 60, 135, 70, 0, 0x0, 0 },
    { BUTTON_CreateIndirect, "clearAll", ID_BUTTON_1, 491, 60, 135, 70, 0, 0x0, 0 },
    { BUTTON_CreateIndirect, "delete", ID_BUTTON_3, 333, 60, 135, 70, 0, 0x0, 0 },
...
static void _cbDialog(WM_MESSAGE * pMsg) {
    ...
    case WM_INIT_DIALOG:
        ...
        BUTTON_SetFont(WM_GetDialogItem(pMsg->hWin, ID_BUTTON_3), &fontwryhcg36e);
    ...
    case WM_NOTIFY_PARENT:
        ...
        case ID_BUTTON_2: //'gun1infobutton'
            ...
            break;  
        case ID_BUTTON_3: //'gun1infobutton'
            switch(NCode) {
            case WM_NOTIFICATION_CLICKED:
                hItem = WM_GetDialogItem(pMsg->hWin, ID_LISTVIEW_0);
                int sel = LISTVIEW_GetSel(hItem);
                LISTVIEW_GetItemText(hItem, 0, sel, deleteId, 24);
                BnWDeleteListCfg(pathWhiteList, deleteId);
                
                LISTVIEW_DeleteRow(hItem, sel);
