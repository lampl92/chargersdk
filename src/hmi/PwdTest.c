...
//        break;
    case WM_PAINT:
        ...
        GUI_MEMDEV_WriteAt(MemdevcardinfoPwdTest, 120, 103);
        break;
    case WM_TIMER:
        ...
        { 
            ...
            if (gbsstate == StatePwdErrorAgain)
            {
                WM_SendMessageNoPara(pMsg->hWin, MSG_JUMPStatePwdErrorAgain);
            }
            if (gbsstate == StatePwdFull)
            {
                WM_SendMessageNoPara(pMsg->hWin, MSG_JUMPStatePwdFull);
            }
    ...
    case MSG_JUMPNetTimeout:
        ...
        CreatenettimeoutDLG();
        break;
    case MSG_JUMPStatePwdErrorAgain:
        GUI_EndDialog(pMsg->hWin, 0);
        CreatePwdErrorAgain();
        break;
    case MSG_JUMPStatePwdFull:
        GUI_EndDialog(pMsg->hWin, 0);
        CreatePwdFull();
        break;
