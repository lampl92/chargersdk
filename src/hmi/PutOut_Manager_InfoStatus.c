...
static void Status_Content_Analy(WM_MESSAGE *pMsg)
{
	...
	/**< 继电器输出L温度 */
    if ((pcont->status.ulSignalAlarm & defSignalCON_Alarm_AC_A_Temp_Cri) == defSignalCON_Alarm_AC_A_CurrUp_Cri)
    {
        //printf_safe("x\n");
...
{
    _hWinManagerInfoStatus = GUI_CreateDialogBox(_aDialogCreate, GUI_COUNTOF(_aDialogCreate), _cbDialog, WM_GetClientWindow(srcHwin), 0, 0);
