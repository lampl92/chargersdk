...
int mbedtlsaesmain()
{
    ...
    //明文空间
    unsigned char plain[32] = {0x80, 0x43, 0x06, 0xA3, 0x4E, 0xB4, 0x35, 0x75, 0x81, 0x22,
                               0xD1, 0x36, 0xAD, 0xEC, 0x11, 0x3A, 0xE1, 0xBD, 0x62, 0x09,
                               0x9D, 0xCB, 0x83, 0x4A, 0xC6, 0xBE, 0x4E, 0x7C, 0x03, 0xEC,
                               0x9E, 0x6C
                              };
