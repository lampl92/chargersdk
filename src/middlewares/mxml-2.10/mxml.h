...
extern mxml_node_t	*mxmlLoadFile(mxml_node_t *top, FIL *fp,
...
extern char		*mxmlSaveAllocString(mxml_node_t *node,
			        	     mxml_save_cb_t cb);
extern int		mxmlSaveFile(mxml_node_t *node, FIL *fp,
			             mxml_save_cb_t cb);
extern int		mxmlSaveString(mxml_node_t *node, char *buffer,
			               int bufsize, mxml_save_cb_t cb);
extern mxml_node_t	*mxmlSAXLoadFile(mxml_node_t *top, FIL *fp,
			                 mxml_type_t (*cb)(mxml_node_t *),
