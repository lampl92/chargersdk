...
**********************************************************************
*/
//#define    RTE_Graphics_Demo_AA_Text
#define    RTE_Graphics_Demo_Automotive
//#define    RTE_Graphics_Demo_BarGraph
#define    RTE_Graphics_Demo_Bitmap
#define    RTE_Graphics_Demo_ColorBar
#define    RTE_Graphics_Demo_Cursor
#define    RTE_Graphics_Demo_Fading
#define    RTE_Graphics_Demo_Graph
//#define    RTE_Graphics_Demo_IconView
#define    RTE_Graphics_Demo_ImageFlow
#define    RTE_Graphics_Demo_ListView
#define    RTE_Graphics_Demo_RadialMenu
#define    RTE_Graphics_Demo_Skinning
#define    RTE_Graphics_Demo_Speed
#define    RTE_Graphics_Demo_Speedometer
#define    RTE_Graphics_Demo_TransparentDialog
//#define    RTE_Graphics_Demo_Treeview
//#define    RTE_Graphics_Demo_VScreen
//#define    RTE_Graphics_Demo_WashingMachine
//#define    RTE_Graphics_Demo_ZoomAndRotate
