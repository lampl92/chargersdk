...
/* Option to compile for FatFS. */
/**
@def		DB_CTCONF_OPTION_TARGET_FatFS
@brief		Build target is FatFS.
@details	Build the database to run on FatFS.
*/
#ifndef DB_CTCONF_OPTION_TARGET_FatFS
#define DB_CTCONF_OPTION_TARGET_FatFS 3
#endif
/******************************************************************************/
