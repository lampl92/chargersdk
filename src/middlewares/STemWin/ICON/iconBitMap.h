...
extern uint8_t iconRead(uint8_t *fPath,const uint8_t *iconPaddr);
extern void createIcon(GUI_BITMAP *bitmap, uint16_t xsize, uint16_t ysize, uint16_t xper, uint16_t yper, const uint8_t *paddr);
