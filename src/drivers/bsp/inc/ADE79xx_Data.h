...
ADE_REGS_DATA DATA_AIGAIN;				  //R/W 24/32 0x400000 U Current Channel Gain (channel A) ?¡ìC 23 bit                                        
ADE_REGS_DATA DATA_AVGAIN;					//R/W 24/32 0x400000 U Voltage Channel Gain ?¡ìC 23 bit                                                    
ADE_REGS_DATA DATA_AWGAIN;				  //R/W 24/32 0x400000 U Active Power Gain (channel A) ?¡ìC 23 bit                                           
ADE_REGS_DATA DATA_AVARGAIN;			  //R/W 24/32 0x400000 U Reactive Power Gain (channel A) ?¡ìC 23 bit                                         
ADE_REGS_DATA DATA_AVAGAIN;				//R/W 24/32 0x400000 U Apparent Power Gain (channel A) ?¡ìC 23 bit                                         
