...
/* Local variables */
static uint8_t  mbuf[32];                /* Modem Command buffer                  */
static uint8_t  mlen;                    /* Length of data in 'mbuf'              */
static uint8_t  modem_st;                /* Modem state                           */
static uint8_t  *dial_num;               /* Dial Target Number                    */
static uint8_t  *reply;                  /* Wait for 'reply'                      */
static uint16_t delay;
static uint8_t  step;
static uint8_t  retries;
static uint8_t wait_for;
static uint8_t wait_conn;
static uint8_t listen_mode;
