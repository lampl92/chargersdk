#ifndef EVSE_VERSION_02_03_0815_H
#define EVSE_VERSION_02_03_0815_H
...
//<----!!!用于生成远程升级文件夹, 一定要与下面版本号一致, 不一致就揍了
    ...
    #define EVSE_MINOR          "03"              //副版本,两位, 对应PDM A1,A2版本
    #define EVSE_PATCH          "08151"           //补丁版本,四位, 目前用作构建日期, 月日表示,
